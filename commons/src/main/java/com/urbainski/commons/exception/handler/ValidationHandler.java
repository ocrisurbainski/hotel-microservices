package com.urbainski.commons.exception.handler;

import com.urbainski.commons.exception.AbstractGenericException;
import com.urbainski.commons.exception.handler.dto.ErrorDTO;
import com.urbainski.commons.exception.handler.dto.ErrorFieldDTO;
...
import com.urbainski.commons.message.SystemMessages;
...
public class ValidationHandler {
    ...
    public ResponseEntity<ResponseErrorDTO> handleWebExchangeBindException(WebExchangeBindException ex) {
        ...
        var responseError = ResponseErrorDTO.builder()
                ...
                .message(messageSourceWrapperComponent.getMessage(SystemMessages.VALIDATION_FAILED.getKey()))
                .details(errors)
                .build();
    ...
    public ResponseEntity<ResponseErrorDTO> handleDuplicateKeyException(DuplicateKeyException ex) {
        ...
        var responseError = ResponseErrorDTO.builder()
                ...
                .message(messageSourceWrapperComponent.getMessage(SystemMessages.DATA_DUPLICATION.getKey()))
