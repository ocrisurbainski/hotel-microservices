...
import com.urbainski.reservations.ReservationRepository;
...
import static com.urbainski.reservations.message.ReservationsSystemMessages.RESERVATION_NOT_FOUND;
...
public class ReservationMongoRepository implements ReservationRepository {
    ...
    @Override
    public Mono<Reservation> checkout(Reservation reservation) {
        return update(reservation);
    }
